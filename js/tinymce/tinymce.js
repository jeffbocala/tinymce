...
(function () {
    ...
    var findCaretPosition = function (direction, startPos, root) {
      ...
      rootContentEditableFalseElm = Arr.last(Arr.filter(getParents(container, root), isContentEditableFalse$5));
    ...
    var start$1 = function (state, editor) {
      return function (e) {
        if (isLeftMouseButtonPressed(e)) {
          var ceElm = Arr.find(editor.dom.getParents(e.target), Fun.or(isContentEditableFalse$6, isContentEditableTrue$3));
