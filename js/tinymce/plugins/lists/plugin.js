...
var lists = (function () {
    ...
    var createSection = function (listType) {
      var section = {
        list: Element$$1.fromTag(listType),
        item: Element$$1.fromTag('li')
      };
    ...
    var createJoinedSections = function (length, listType) {
      var sections = [];
      var _loop_1 = function (i) {
        var newSection = createSection(listType);
    ...
    var createItem = function (attr, content) {
      var item = Element$$1.fromTag('li');
      setAll(item, attr);
    ...
    var writeShallow = function (outline, entry) {
    ...
    var writeDeep = function (outline, entry) {
      var newSections = createJoinedSections(entry.depth - outline.length, entry.listType);
    ...
    var composeList = function (entries) {
    ...
    var hasFirstChildList = function (li) {
      return firstChild(li).map(isList).getOr(false);
    };
    var hasLastChildList = function (li) {
      return lastChild(li).map(isList).getOr(false);
    };
    ...
    var parseItem = function (depth, itemSelection, selectionState, item) {
      ...
      return firstChild(item).filter(isList).fold(function () {
        ...
        var fromChildList = lastChild(item).filter(isList).map(curriedParseList).getOr([]);
    ...
    var parseList = function (depth, itemSelection, selectionState, list) {
      ...
      return bind(children(list), function (child$$1) {
        return isList(child$$1) ? parseList(newDepth, itemSelection, selectionState, child$$1) : parseItem(newDepth, itemSelection, selectionState, child$$1);
      });
    };
    ...
    var indentedComposer = function (entries) {
